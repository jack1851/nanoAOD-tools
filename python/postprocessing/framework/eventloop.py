...
#           self.dir = self.histFile.mkdir(histDirName)
	...
	prevdir = ROOT.gDirectory
        ...
        self.CR_unweighted_ll_Dir.cd()
        self.CR_unweighted_ll.WriteHists()
        self.CR_unweighted_ee_Dir.cd()
        self.CR_unweighted_ee.WriteHists()
        self.CR_unweighted_mumu_Dir.cd()
        self.CR_unweighted_mumu.WriteHists()

        prevdir.cd()
        self.CR_Directory.cd()
        self.CR_data_Directory.cd()
        self.CR_data_ll_Dir.cd()
        self.CR_data_ll.WriteHists()
        self.CR_data_ee_Dir.cd()
        self.CR_data_ee.WriteHists()
        self.CR_data_mumu_Dir.cd()
        self.CR_data_mumu.WriteHists()

        prevdir.cd()
        self.CR_Directory.cd()
        self.CR_reweighted_Directory.cd()
        self.CR_reweighted_ll_Dir.cd()
        self.CR_reweighted_ll.WriteHists()
        self.CR_reweighted_ee_Dir.cd()
        self.CR_reweighted_ee.WriteHists()
        self.CR_reweighted_mumu_Dir.cd()
        self.CR_reweighted_mumu.WriteHists()

	prevdir.cd()
        self.SR_Directory.cd()
        self.SR_unweighted_Directory.cd()
 	self.SR_unweighted_ll_Dir.cd()
        self.SR_unweighted_ll.WriteHists()
        self.SR_unweighted_ee_Dir.cd()
        self.SR_unweighted_ee.WriteHists()
        self.SR_unweighted_mumu_Dir.cd()
        self.SR_unweighted_mumu.WriteHists()

        prevdir.cd()
        self.SR_Directory.cd()
        self.SR_data_Directory.cd()
        self.SR_data_ll_Dir.cd()
        self.SR_data_ll.WriteHists()
        self.SR_data_ee_Dir.cd()
        self.SR_data_ee.WriteHists()
        self.SR_data_mumu_Dir.cd()
        self.SR_data_mumu.WriteHists()

        prevdir.cd()
        self.SR_Directory.cd()
        self.SR_reweighted_Directory.cd()
        self.SR_reweighted_ll_Dir.cd()
        self.SR_reweighted_ll.WriteHists()
        self.SR_reweighted_ee_Dir.cd()
        self.SR_reweighted_ee.WriteHists()
        self.SR_reweighted_mumu_Dir.cd()
        self.SR_reweighted_mumu.WriteHists()
