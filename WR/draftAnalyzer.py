...
from PhysicsTools.NanoAODTools.postprocessing.framework.newpostprocessor import PostProcessor
...
#################################################################################################################################################################################################
        ...
        self.object1.eventcounts(event)
        self.object2.eventcounts(event)
        self.object3.eventcounts(event)
